...
export class StudentService{
  ...
  private apiStudentServer = 'http://localhost:8080/api/student' //connect to backend
  ...
  public getStudentImage(studentId: number ): Observable<any>
  {
    return this.http.get<any>(`${this.apiStudentServer}/${studentId}/download/image`);
  }
